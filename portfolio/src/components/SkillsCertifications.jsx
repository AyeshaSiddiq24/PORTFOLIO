              ...
              <div key={idx} style={styles.certCard}>
                <div style={styles.certRow}>
                  <div style={styles.logoBadge}>
                    <img src={cert.logo} alt={cert.title} style={styles.logo} />
                  </div>
                  <div>
...
function getStyles(isMobile, isTablet) {
  return {
    ...
    skillGrid: { display: "grid", gap: "24px" },
    ...
    skillCategory: { fontSize: "16px", fontWeight: 600 },
    ...
    certList: { display: "flex", flexDirection: "column", gap: "18px" },
    ...
    certRow: { display: "flex", gap: "18px", alignItems: "center" },
    ...
    certTitle: { fontSize: "16px", fontWeight: 600 },

    certOrg: { fontSize: "14px", color: "#94a3b8" },

    certSkills: { fontSize: "13px", color: "#cbd5f5" },
  };
}
